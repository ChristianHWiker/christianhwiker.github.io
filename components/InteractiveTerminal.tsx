...
const COMMANDS: Record<string, () => Line[]> = {
  ...
  about: () => [
    ...
    { type: "output", text: "Currently building standalone services and modern web applications at Pelias." },
    { type: "output", text: "" },
  ...
  projects: () => [
    ...
    { type: "output", text: "" },
    { type: "accent", text: "1. Development Platform & DevOps" },
    { type: "output", text: "   Coding standard, Visual Studio project template, Azure" },
    { type: "output", text: "   DevOps Server, and a two-VM Docker build & test platform." },
    { type: "output", text: "   Impact: Designed and built, now running." },
    { type: "output", text: "" },
    { type: "accent", text: "2. Pelias Access Suite" },
    { type: "output", text: "   Dashboard and shared login. Pelias ID answers who you are," },
    { type: "output", text: "   the dashboard owns the application rights." },
    { type: "output", text: "   Status: Pelias ID done, dashboard in progress." },
    { type: "output", text: "" },
    { type: "accent", text: "3. Email Worker Service" },
    { type: "output", text: "   C# service replacing legacy ASP Classic email pipeline." },
    { type: "output", text: "   Impact: Removed 1h+ of downtime a day on average." },
    { type: "output", text: "" },
    { type: "accent", text: "4. Blazor Map Application" },
    { type: "output", text: "   Map & trend visualization tool built for Pelias." },
    { type: "output", text: "   Impact: Kept in-house after prototype demo." },
    { type: "output", text: "" },
    { type: "accent", text: "5. AI Productivity Training" },
